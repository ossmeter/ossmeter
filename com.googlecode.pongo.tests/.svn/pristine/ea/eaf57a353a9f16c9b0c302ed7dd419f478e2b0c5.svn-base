...
public abstract class Mammal extends Animal {
	...
	public Mammal() { 
		...
		SPECIES.setOwningType("com.googlecode.pongo.tests.zoo.model.Mammal");
		NAME.setOwningType("com.googlecode.pongo.tests.zoo.model.Mammal");
		WEIGHT.setOwningType("com.googlecode.pongo.tests.zoo.model.Mammal");
		HEIGHT.setOwningType("com.googlecode.pongo.tests.zoo.model.Mammal");
		AGE.setOwningType("com.googlecode.pongo.tests.zoo.model.Mammal");
		ORIGIN.setOwningType("com.googlecode.pongo.tests.zoo.model.Mammal");
	}
