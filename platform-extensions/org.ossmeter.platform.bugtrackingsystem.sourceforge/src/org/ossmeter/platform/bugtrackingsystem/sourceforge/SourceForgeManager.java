...
public class SourceForgeManager implements
    ...
    private static class TicketCacheProvider extends
        ...
        @Override
        public Iterable<SourceForgeTicket> getItems(java.util.Date after,
                java.util.Date before, BugTrackingSystem bugTracker) throws Exception {
    ...
    @Override
    public BugTrackingSystemDelta getDelta(SourceForgeBugTrackingSystem bugTracker,
            Date date) throws Exception {

        java.util.Date day = date.toJavaDate();

        BugTrackerItemCache<SourceForgeTicket, String> ticketCache = ticketCaches.getCache(bugTracker, true);
        ...
        for (SourceForgeTicket ticket : tickets) {
            ...
            // TODO is this needed?
            ticket.setBugTrackingSystem(bugTracker);
        }
    ...
    @Override
    public Date getFirstDate(SourceForgeBugTrackingSystem bugTracker) throws Exception {
    ...
    private static SourceForgeTrackerRestClient getSourceForge(
            SourceForgeBugTrackingSystem bts) throws URISyntaxException {
        return new SourceForgeTrackerRestClient(bts.getUrl());
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        delta = (SourceForgeTrackingSystemDelta) manager
                .getDelta(bts,
                        new Date(new DateTime(2014, 6, 16, 0, 0).toDate()));
