...
public class SourceForgeTrackerRestClient {
     ...
     * @throws IOException
     */
    public Iterable<SourceForgeTicket> getTickets(Date after, Date before)
        ...
        return new SourceForgeTickets(this, getTicketIds(query).iterator());
    }


    public Iterable<Integer> getTicketIds(String query) {
        return new SourceForgeTicketIds(this, query);
    }
