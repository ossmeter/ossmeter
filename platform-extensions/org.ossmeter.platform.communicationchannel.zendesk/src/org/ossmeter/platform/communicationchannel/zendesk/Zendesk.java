...
import org.ossmeter.platform.communicationchannel.zendesk.model.Attachment;
import org.ossmeter.platform.communicationchannel.zendesk.model.Audit;
import org.ossmeter.platform.communicationchannel.zendesk.model.Comment;
import org.ossmeter.platform.communicationchannel.zendesk.model.Field;
import org.ossmeter.platform.communicationchannel.zendesk.model.Forum;
import org.ossmeter.platform.communicationchannel.zendesk.model.Group;
import org.ossmeter.platform.communicationchannel.zendesk.model.GroupMembership;
import org.ossmeter.platform.communicationchannel.zendesk.model.Identity;
import org.ossmeter.platform.communicationchannel.zendesk.model.Organization;
import org.ossmeter.platform.communicationchannel.zendesk.model.OrganizationField;
import org.ossmeter.platform.communicationchannel.zendesk.model.SearchResultEntity;
import org.ossmeter.platform.communicationchannel.zendesk.model.Status;
import org.ossmeter.platform.communicationchannel.zendesk.model.Ticket;
import org.ossmeter.platform.communicationchannel.zendesk.model.Topic;
import org.ossmeter.platform.communicationchannel.zendesk.model.User;
import org.ossmeter.platform.communicationchannel.zendesk.model.UserField;
...
public class Zendesk implements Closeable {
    ...
    public Iterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request> getRequests() {
        return new PagedIterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests.json"),
                handleList(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request> getOpenRequests() {
        return new PagedIterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests/open.json"),
                handleList(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request> getSolvedRequests() {
        return new PagedIterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests/solved.json"),
                handleList(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request> getCCRequests() {
        return new PagedIterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests/ccd.json"),
                handleList(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request> getUserRequests(User user) {
        checkHasId(user);
        return getUserRequests(user.getId());
    }

    public Iterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request> getUserRequests(long id) {
        return new PagedIterable<org.ossmeter.platform.communicationchannel.zendesk.model.Request>(tmpl("/users/{id}/requests.json").set("id", id),
                handleList(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public org.ossmeter.platform.communicationchannel.zendesk.model.Request getRequest(long id) {
        return complete(submit(req("GET", tmpl("/requests/{id}.json").set("id", id)),
                handle(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "request")));
    }

    public org.ossmeter.platform.communicationchannel.zendesk.model.Request createRequest(org.ossmeter.platform.communicationchannel.zendesk.model.Request request) {
        return complete(submit(req("POST", cnst("/requests.json"),
                        JSON, json(Collections.singletonMap("request", request))),
                handle(org.ossmeter.platform.communicationchannel.zendesk.model.Request.class, "request")));
    }

    public org.ossmeter.platform.communicationchannel.zendesk.model.Request updateRequest(org.ossmeter.platform.communicationchannel.zendesk.model.Request request) {
        checkHasId(request);
    ...
    public Iterable<Comment> getRequestComments(org.ossmeter.platform.communicationchannel.zendesk.model.Request request) {
        checkHasId(request);
    ...
    public Comment getRequestComment(org.ossmeter.platform.communicationchannel.zendesk.model.Request request, Comment comment) {
        checkHasId(comment);
        return getRequestComment(request, comment.getId());
    }

    public Comment getRequestComment(org.ossmeter.platform.communicationchannel.zendesk.model.Request request, long commentId) {
        checkHasId(request);
    ...
    private static void checkHasId(org.ossmeter.platform.communicationchannel.zendesk.model.Request request) {
