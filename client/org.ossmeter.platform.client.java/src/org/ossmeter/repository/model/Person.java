...
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME,
	...
	property = "_type")
@JsonSubTypes({
	@Type(value = Person.class, name="Person"), 	@Type(value = org.ossmeter.repository.model.github.GitHubUser.class, name="org.ossmeter.repository.model.github.GitHubUser"),
