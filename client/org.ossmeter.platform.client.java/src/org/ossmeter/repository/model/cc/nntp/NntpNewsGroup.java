...
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME,
	...
	property = "_type")
@JsonSubTypes({
	@Type(value = NntpNewsGroup.class, name="NntpNewsGroup"), 	@Type(value = org.ossmeter.repository.model.eclipse.EclipseNewsGroup.class, name="org.ossmeter.repository.model.eclipse.EclipseNewsGroup"),
})
