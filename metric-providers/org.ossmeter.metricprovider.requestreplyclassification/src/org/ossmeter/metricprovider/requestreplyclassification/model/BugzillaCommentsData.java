...
public class BugzillaCommentsData extends Pongo {
	...
	public BugzillaCommentsData() { 
		super();
		URL.setOwningType("org.ossmeter.metricprovider.requestreplyclassification.model.BugzillaCommentsData");
		PROD.setOwningType("org.ossmeter.metricprovider.requestreplyclassification.model.BugzillaCommentsData");
		COMP.setOwningType("org.ossmeter.metricprovider.requestreplyclassification.model.BugzillaCommentsData");
		BUGID.setOwningType("org.ossmeter.metricprovider.requestreplyclassification.model.BugzillaCommentsData");
		COMMENTID.setOwningType("org.ossmeter.metricprovider.requestreplyclassification.model.BugzillaCommentsData");
		CLASSIFICATIONRESULT.setOwningType("org.ossmeter.metricprovider.requestreplyclassification.model.BugzillaCommentsData");
	}
