...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.trans.contentclassesnntp.model.NewsgroupData");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.trans.contentclassesnntp.model.NewsgroupData");
	}
