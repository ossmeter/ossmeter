...
public class ContentClass extends Pongo {
	...
	public ContentClass() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.trans.contentclassesnntp.model.ContentClass");
		CLASSLABEL.setOwningType("org.ossmeter.metricprovider.trans.contentclassesnntp.model.ContentClass");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.trans.contentclassesnntp.model.ContentClass");
		PERCENTAGE.setOwningType("org.ossmeter.metricprovider.trans.contentclassesnntp.model.ContentClass");
	}
