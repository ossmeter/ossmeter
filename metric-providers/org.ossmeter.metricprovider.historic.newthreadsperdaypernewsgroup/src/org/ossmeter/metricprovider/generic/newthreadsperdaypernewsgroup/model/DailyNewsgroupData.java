...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.generic.newthreadsperdaypernewsgroup.model.DailyNewsgroupData");
		NUMBEROFNEWTHREADS.setOwningType("org.ossmeter.metricprovider.generic.newthreadsperdaypernewsgroup.model.DailyNewsgroupData");
	}
