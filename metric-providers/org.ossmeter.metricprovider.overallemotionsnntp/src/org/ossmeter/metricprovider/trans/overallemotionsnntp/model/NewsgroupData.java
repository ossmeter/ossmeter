...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.trans.overallemotionsnntp.model.NewsgroupData");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.trans.overallemotionsnntp.model.NewsgroupData");
	}
