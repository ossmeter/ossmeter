...
import org.ossmeter.metricprovider.trans.overallemotionsnntp.model.OverallEmotionNNTP;
...
public class OverallEmotionsMetricProvider implements ITransientMetricProvider<OverallEmotionNNTP>{
	...
	@Override
	public OverallEmotionNNTP adapt(DB db) {
		return new OverallEmotionNNTP(db);
	}

	@Override
	public void measure(Project project, ProjectDelta projectDelta, OverallEmotionNNTP db) {
