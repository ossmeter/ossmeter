...
public class BugTrackerComments extends Pongo {
	...
	public BugTrackerComments() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.requestreplyclassification.model.BugTrackerComments");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.requestreplyclassification.model.BugTrackerComments");
		COMMENTID.setOwningType("org.ossmeter.metricprovider.trans.requestreplyclassification.model.BugTrackerComments");
		CLASSIFICATIONRESULT.setOwningType("org.ossmeter.metricprovider.trans.requestreplyclassification.model.BugTrackerComments");
		DATE.setOwningType("org.ossmeter.metricprovider.trans.requestreplyclassification.model.BugTrackerComments");
	}
