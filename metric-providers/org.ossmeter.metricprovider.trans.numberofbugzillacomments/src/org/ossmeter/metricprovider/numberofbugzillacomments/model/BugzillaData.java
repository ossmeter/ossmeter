...
public class BugzillaData extends Pongo {
	...
	public BugzillaData() { 
		super();
		URL.setOwningType("org.ossmeter.metricprovider.numberofbugzillacomments.model.BugzillaData");
		PRODUCT.setOwningType("org.ossmeter.metricprovider.numberofbugzillacomments.model.BugzillaData");
		COMPONENT.setOwningType("org.ossmeter.metricprovider.numberofbugzillacomments.model.BugzillaData");
		NUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.numberofbugzillacomments.model.BugzillaData");
	}
