...
public class DailyBugData extends Pongo {
	...
	public DailyBugData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.historic.bugs.patches.model.DailyBugData");
		NUMBEROFPATCHES.setOwningType("org.ossmeter.metricprovider.historic.bugs.patches.model.DailyBugData");
		CUMULATIVENUMBEROFPATCHES.setOwningType("org.ossmeter.metricprovider.historic.bugs.patches.model.DailyBugData");
	}
