...
public class HourComments extends Pongo {
	...
	public HourComments() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		HOUR.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		NUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		NUMBEROFREQUESTS.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		NUMBEROFREPLIES.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		PERCENTAGEOFCOMMENTS.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		PERCENTAGEOFREQUESTS.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		PERCENTAGEOFREPLIES.setOwningType("org.ossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
	}
