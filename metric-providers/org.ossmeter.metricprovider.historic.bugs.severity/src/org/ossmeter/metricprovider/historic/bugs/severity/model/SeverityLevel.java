...
public class SeverityLevel extends Pongo {
	...
	public SeverityLevel() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.historic.bugs.severity.model.SeverityLevel");
		SEVERITYLEVEL.setOwningType("org.ossmeter.metricprovider.historic.bugs.severity.model.SeverityLevel");
		NUMBEROFBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severity.model.SeverityLevel");
		PERCENTAGE.setOwningType("org.ossmeter.metricprovider.historic.bugs.severity.model.SeverityLevel");
	}
