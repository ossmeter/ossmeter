...
public class NewsgroupsRequestsRepliesHistoricMetric extends Pongo {
	...
	public NewsgroupsRequestsRepliesHistoricMetric() { 
		...
		NUMBEROFREQUESTS.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.requestsreplies.model.NewsgroupsRequestsRepliesHistoricMetric");
		NUMBEROFREPLIES.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.requestsreplies.model.NewsgroupsRequestsRepliesHistoricMetric");
		CUMULATIVENUMBEROFREQUESTS.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.requestsreplies.model.NewsgroupsRequestsRepliesHistoricMetric");
		CUMULATIVENUMBEROFREPLIES.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.requestsreplies.model.NewsgroupsRequestsRepliesHistoricMetric");
	}
