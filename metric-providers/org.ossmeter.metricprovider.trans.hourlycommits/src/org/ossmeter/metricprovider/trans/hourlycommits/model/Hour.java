...
public class Hour extends Pongo {
	...
	public Hour() { 
		super();
		HOUR.setOwningType("org.ossmeter.metricprovider.trans.hourlycommits.model.Hour");
		NUMBEROFCOMMITS.setOwningType("org.ossmeter.metricprovider.trans.hourlycommits.model.Hour");
	}
