...
public class BugsNewUsersHistoricMetric extends Pongo {
	...
	public BugsNewUsersHistoricMetric() { 
		...
		NUMBEROFNEWUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.newusers.model.BugsNewUsersHistoricMetric");
		CUMULATIVENUMBEROFNEWUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.newusers.model.BugsNewUsersHistoricMetric");
	}
