...
public class ArticleData extends Pongo {
	...
	public ArticleData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.trans.threads.model.ArticleData");
		ARTICLENUMBER.setOwningType("org.ossmeter.metricprovider.trans.threads.model.ArticleData");
		ARTICLEID.setOwningType("org.ossmeter.metricprovider.trans.threads.model.ArticleData");
