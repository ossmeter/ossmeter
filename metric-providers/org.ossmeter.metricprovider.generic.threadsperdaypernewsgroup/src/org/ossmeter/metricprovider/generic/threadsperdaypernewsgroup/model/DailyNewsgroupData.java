...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.generic.threadsperdaypernewsgroup.model.DailyNewsgroupData");
		NUMBEROFTHREADS.setOwningType("org.ossmeter.metricprovider.generic.threadsperdaypernewsgroup.model.DailyNewsgroupData");
	}
