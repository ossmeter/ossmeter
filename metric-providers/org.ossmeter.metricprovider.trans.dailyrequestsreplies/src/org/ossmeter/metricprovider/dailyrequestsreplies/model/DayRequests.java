...
public class DayRequests extends Pongo {
	...
	public DayRequests() { 
		super();
		NAME.setOwningType("org.ossmeter.metricprovider.dailyrequestsreplies.model.DayRequests");
		NUMBEROFREQUESTS.setOwningType("org.ossmeter.metricprovider.dailyrequestsreplies.model.DayRequests");
	}
