...
public class DayArticles extends Pongo {
	...
	public DayArticles() { 
		super();
		NAME.setOwningType("org.ossmeter.metricprovider.dailyrequestsreplies.model.DayArticles");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.dailyrequestsreplies.model.DayArticles");
	}
