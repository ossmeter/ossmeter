...
public class BugData extends Pongo {
	...
	public BugData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.bugs.activeusers.model.BugData");
		ACTIVEUSERS.setOwningType("org.ossmeter.metricprovider.trans.bugs.activeusers.model.BugData");
		INACTIVEUSERS.setOwningType("org.ossmeter.metricprovider.trans.bugs.activeusers.model.BugData");
		PREVIOUSUSERS.setOwningType("org.ossmeter.metricprovider.trans.bugs.activeusers.model.BugData");
		USERS.setOwningType("org.ossmeter.metricprovider.trans.bugs.activeusers.model.BugData");
		DAYS.setOwningType("org.ossmeter.metricprovider.trans.bugs.activeusers.model.BugData");
	}
