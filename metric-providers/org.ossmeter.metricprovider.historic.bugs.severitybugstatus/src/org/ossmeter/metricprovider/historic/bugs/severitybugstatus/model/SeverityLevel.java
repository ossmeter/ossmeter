...
public class SeverityLevel extends Pongo {
	...
	public SeverityLevel() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		SEVERITYLEVEL.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFRESOLVEDCLOSEDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFRESOLVEDCLOSEDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFWONTFIXBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFWONTFIXBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFWORKSFORMEBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFWORKSFORMEBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFNONRESOLVEDCLOSEDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFNONRESOLVEDCLOSEDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFINVALIDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFINVALIDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFFIXEDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFFIXEDBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFDUPLICATEBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFDUPLICATEBUGS.setOwningType("org.ossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
	}
