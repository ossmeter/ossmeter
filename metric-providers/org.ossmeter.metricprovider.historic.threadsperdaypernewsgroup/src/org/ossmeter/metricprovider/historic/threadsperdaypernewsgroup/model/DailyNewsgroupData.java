...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.historic.threadsperdaypernewsgroup.model.DailyNewsgroupData");
		NUMBEROFTHREADS.setOwningType("org.ossmeter.metricprovider.historic.threadsperdaypernewsgroup.model.DailyNewsgroupData");
	}
