...
public class BugTrackerData extends Pongo {
	...
	public BugTrackerData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.bugs.patches.model.BugTrackerData");
		NUMBEROFPATCHES.setOwningType("org.ossmeter.metricprovider.trans.bugs.patches.model.BugTrackerData");
		CUMULATIVENUMBEROFPATCHES.setOwningType("org.ossmeter.metricprovider.trans.bugs.patches.model.BugTrackerData");
	}
