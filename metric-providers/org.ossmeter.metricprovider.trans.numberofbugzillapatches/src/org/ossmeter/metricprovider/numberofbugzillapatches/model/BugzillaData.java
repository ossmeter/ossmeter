...
public class BugzillaData extends Pongo {
	...
	public BugzillaData() { 
		super();
		URL.setOwningType("org.ossmeter.metricprovider.numberofbugzillapatches.model.BugzillaData");
		PRODUCT.setOwningType("org.ossmeter.metricprovider.numberofbugzillapatches.model.BugzillaData");
		COMPONENT.setOwningType("org.ossmeter.metricprovider.numberofbugzillapatches.model.BugzillaData");
		NUMBEROFPATCHES.setOwningType("org.ossmeter.metricprovider.numberofbugzillapatches.model.BugzillaData");
	}
