...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.ossmeter.metricprovider.trans.newsgroups.articles.model.NewsgroupData");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.trans.newsgroups.articles.model.NewsgroupData");
		CUMULATIVENUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.trans.newsgroups.articles.model.NewsgroupData");
	}
