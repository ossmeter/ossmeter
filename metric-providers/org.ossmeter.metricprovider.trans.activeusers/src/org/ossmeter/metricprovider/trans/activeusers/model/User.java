...
public class User extends Pongo {
	...
	public User() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.trans.activeusers.model.User");
		USERID.setOwningType("org.ossmeter.metricprovider.trans.activeusers.model.User");
		LASTACTIVITYDATE.setOwningType("org.ossmeter.metricprovider.trans.activeusers.model.User");
		ARTICLES.setOwningType("org.ossmeter.metricprovider.trans.activeusers.model.User");
		REQUESTS.setOwningType("org.ossmeter.metricprovider.trans.activeusers.model.User");
		REPLIES.setOwningType("org.ossmeter.metricprovider.trans.activeusers.model.User");
	}
