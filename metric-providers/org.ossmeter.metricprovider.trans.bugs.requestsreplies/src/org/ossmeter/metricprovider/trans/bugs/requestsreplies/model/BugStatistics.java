package org.ossmeter.metricprovider.trans.bugs.requestsreplies.model;
...
public class BugStatistics extends Pongo {
	...
	public BugStatistics() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.bugs.requestsreplies.model.BugStatistics");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.bugs.requestsreplies.model.BugStatistics");
		FIRSTREQUEST.setOwningType("org.ossmeter.metricprovider.trans.bugs.requestsreplies.model.BugStatistics");
		ANSWERED.setOwningType("org.ossmeter.metricprovider.trans.bugs.requestsreplies.model.BugStatistics");
		RESPONSEDURATIONSEC.setOwningType("org.ossmeter.metricprovider.trans.bugs.requestsreplies.model.BugStatistics");
		RESPONSEDATE.setOwningType("org.ossmeter.metricprovider.trans.bugs.requestsreplies.model.BugStatistics");
	}
