...
public class BugTrackerBugsData extends Pongo {
	...
	public BugTrackerBugsData() { 
		...
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		SEVERITY.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		UNIGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		BIGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		TRIGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		QUADGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		CHARTRIGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		CHARQUADGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
		CHARFIVEGRAMS.setOwningType("org.ossmeter.metricprovider.trans.severityclassification.model.BugTrackerBugsData");
	}
