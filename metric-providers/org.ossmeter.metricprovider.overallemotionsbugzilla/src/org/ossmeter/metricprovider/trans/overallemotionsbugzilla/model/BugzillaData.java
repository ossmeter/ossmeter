...
public class BugzillaData extends Pongo {
	...
	public BugzillaData() { 
		super();
		URL.setOwningType("org.ossmeter.metricprovider.trans.overallemotionsbugzilla.model.BugzillaData");
		PRODUCT.setOwningType("org.ossmeter.metricprovider.trans.overallemotionsbugzilla.model.BugzillaData");
		COMPONENT.setOwningType("org.ossmeter.metricprovider.trans.overallemotionsbugzilla.model.BugzillaData");
		NUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.trans.overallemotionsbugzilla.model.BugzillaData");
	}
