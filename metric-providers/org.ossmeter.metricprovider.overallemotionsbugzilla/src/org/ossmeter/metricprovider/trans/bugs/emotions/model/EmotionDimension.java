...
public class EmotionDimension extends Pongo {
	...
	public EmotionDimension() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.bugs.emotions.model.EmotionDimension");
		EMOTIONLABEL.setOwningType("org.ossmeter.metricprovider.trans.bugs.emotions.model.EmotionDimension");
		NUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.trans.bugs.emotions.model.EmotionDimension");
		CUMULATIVENUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.trans.bugs.emotions.model.EmotionDimension");
		PERCENTAGE.setOwningType("org.ossmeter.metricprovider.trans.bugs.emotions.model.EmotionDimension");
		CUMULATIVEPERCENTAGE.setOwningType("org.ossmeter.metricprovider.trans.bugs.emotions.model.EmotionDimension");
	}
