...
public class BugsUsersHistoricMetric extends Pongo {
	...
	public BugsUsersHistoricMetric() { 
		...
		NUMBEROFUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.BugsUsersHistoricMetric");
		NUMBEROFACTIVEUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.BugsUsersHistoricMetric");
		NUMBEROFINACTIVEUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.BugsUsersHistoricMetric");
	}
