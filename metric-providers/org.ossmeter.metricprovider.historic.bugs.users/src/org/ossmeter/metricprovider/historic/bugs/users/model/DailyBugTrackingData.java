 ...
 *******************************************************************************/
package org.ossmeter.metricprovider.historic.bugs.users.model;
...
public class DailyBugTrackingData extends Pongo {
	...
	public DailyBugTrackingData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.DailyBugTrackingData");
		NUMBEROFUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.DailyBugTrackingData");
		NUMBEROFACTIVEUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.DailyBugTrackingData");
		NUMBEROFINACTIVEUSERS.setOwningType("org.ossmeter.metricprovider.historic.bugs.users.model.DailyBugTrackingData");
	}
