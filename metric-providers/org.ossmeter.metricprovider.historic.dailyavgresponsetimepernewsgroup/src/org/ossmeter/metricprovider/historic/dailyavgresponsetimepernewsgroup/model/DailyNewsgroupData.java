...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.historic.dailyavgresponsetimepernewsgroup.model.DailyNewsgroupData");
		AVGRESPONSETIME.setOwningType("org.ossmeter.metricprovider.historic.dailyavgresponsetimepernewsgroup.model.DailyNewsgroupData");
		THREADSCONSIDERED.setOwningType("org.ossmeter.metricprovider.historic.dailyavgresponsetimepernewsgroup.model.DailyNewsgroupData");
	}
