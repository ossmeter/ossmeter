...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.generic.numberofactivecommittersperday.model.DailyNewsgroupData");
		NUMBEROFACTIVECOMMITTERS.setOwningType("org.ossmeter.metricprovider.generic.numberofactivecommittersperday.model.DailyNewsgroupData");
	}
