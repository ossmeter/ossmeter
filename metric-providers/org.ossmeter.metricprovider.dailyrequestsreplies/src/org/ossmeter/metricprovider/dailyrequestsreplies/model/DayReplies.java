...
public class DayReplies extends Pongo {
	...
	public DayReplies() { 
		super();
		NAME.setOwningType("org.ossmeter.metricprovider.dailyrequestsreplies.model.DayReplies");
		NUMBEROFREPLIES.setOwningType("org.ossmeter.metricprovider.dailyrequestsreplies.model.DayReplies");
	}
