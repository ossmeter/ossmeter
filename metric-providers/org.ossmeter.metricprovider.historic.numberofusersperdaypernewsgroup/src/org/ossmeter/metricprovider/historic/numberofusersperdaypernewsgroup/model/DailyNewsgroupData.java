...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.historic.numberofusersperdaypernewsgroup.model.DailyNewsgroupData");
		NUMBEROFUSERS.setOwningType("org.ossmeter.metricprovider.historic.numberofusersperdaypernewsgroup.model.DailyNewsgroupData");
	}
