package org.ossmeter.metricprovider.historic.numberofusersperdaypernewsgroup;

import java.util.Arrays;
import java.util.List;

import org.ossmeter.metricprovider.historic.numberofusersperdaypernewsgroup.model.DailyNewsgroupData;
import org.ossmeter.metricprovider.historic.numberofusersperdaypernewsgroup.model.DailyUsers;
...
public class NumberOfUsersPerDayPerNewsgroupProvider extends AbstractHistoricalMetricProvider{

	public final static String IDENTIFIER = 
			"org.ossmeter.metricprovider.historic.numberofusersperdaypernewsgroup";
	...
	public String getShortIdentifier() {
		return "userspernewsgroup";
	}

	@Override
	public String getFriendlyName() {
		return "Number Of Users Per Day Per Newsgroup Provider";
	}

	@Override
	public String getSummaryInformation() {
		return "This metric computes the number of users " +
