...
/**
 * TEMPORARY CLASS. USED PURELY FOR REVIEW DEMO.
 * @author jimmy
 *
 */
public class GenericTotalLocMetricProvider2 implements IHistoricalMetricProvider{

	public final static String IDENTIFIER = "totalloc2";
