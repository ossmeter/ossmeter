...
public class DailyBugzillaData extends Pongo {
	...
	public DailyBugzillaData() { 
		super();
		AVGBUGOPENTIME.setOwningType("org.ossmeter.metricprovider.generic.avgbugcreationclosedtime.model.DailyBugzillaData");
		BUGSCONSIDERED.setOwningType("org.ossmeter.metricprovider.generic.avgbugcreationclosedtime.model.DailyBugzillaData");
	}
