...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.threads.model.NewsgroupData");
		THREADS.setOwningType("org.ossmeter.metricprovider.threads.model.NewsgroupData");
		PREVIOUSTHREADS.setOwningType("org.ossmeter.metricprovider.threads.model.NewsgroupData");
	}
