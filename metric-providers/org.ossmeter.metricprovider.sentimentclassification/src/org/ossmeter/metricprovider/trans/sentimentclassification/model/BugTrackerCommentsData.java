...
public class BugTrackerCommentsData extends Pongo {
	...
	public BugTrackerCommentsData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugTrackerCommentsData");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugTrackerCommentsData");
		COMMENTID.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugTrackerCommentsData");
		CLASSIFICATIONRESULT.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugTrackerCommentsData");
		EMOTIONALDIMENSIONS.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugTrackerCommentsData");
	}
