...
public class BugzillaCommentsData extends Pongo {
	...
	public BugzillaCommentsData() { 
		super();
		URL.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
		PROD.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
		COMP.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
		COMMENTID.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
		CLASSIFICATIONRESULT.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
		EMOTIONALDIMENSIONS.setOwningType("org.ossmeter.metricprovider.trans.sentimentclassification.model.BugzillaCommentsData");
	}
	...
	public BugzillaCommentsData setEmotionalDimensions(String emotionalDimensions) {
