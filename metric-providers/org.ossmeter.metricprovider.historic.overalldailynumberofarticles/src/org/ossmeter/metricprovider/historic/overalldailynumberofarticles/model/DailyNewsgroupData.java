package org.ossmeter.metricprovider.historic.overalldailynumberofarticles.model;
...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.historic.overalldailynumberofarticles.model.DailyNewsgroupData");
	}
