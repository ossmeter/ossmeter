...
public class HourArticles extends Pongo {
	...
	public HourArticles() { 
		super();
		HOUR.setOwningType("org.ossmeter.metricprovider.trans.hourlyrequestsreplies.model.HourArticles");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.trans.hourlyrequestsreplies.model.HourArticles");
	}
