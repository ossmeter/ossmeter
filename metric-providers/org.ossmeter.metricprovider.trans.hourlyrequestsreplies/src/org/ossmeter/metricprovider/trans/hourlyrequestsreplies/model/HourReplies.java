...
public class HourReplies extends Pongo {
	...
	public HourReplies() { 
		super();
		HOUR.setOwningType("org.ossmeter.metricprovider.trans.hourlyrequestsreplies.model.HourReplies");
		NUMBEROFREPLIES.setOwningType("org.ossmeter.metricprovider.trans.hourlyrequestsreplies.model.HourReplies");
	}
