...
public class HourRequests extends Pongo {
	...
	public HourRequests() { 
		super();
		HOUR.setOwningType("org.ossmeter.metricprovider.hourlyrequestsreplies.model.HourRequests");
		NUMBEROFREQUESTS.setOwningType("org.ossmeter.metricprovider.hourlyrequestsreplies.model.HourRequests");
	}
