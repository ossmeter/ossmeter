 ...
 *******************************************************************************/
package org.ossmeter.metricprovider.historic.bugs.comments.model;
...
public class DailyBugData extends Pongo {
	...
	public DailyBugData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.historic.bugs.comments.model.DailyBugData");
		NUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.historic.bugs.comments.model.DailyBugData");
		CUMULATIVENUMBEROFCOMMENTS.setOwningType("org.ossmeter.metricprovider.historic.bugs.comments.model.DailyBugData");
	}
