...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.historic.numberofnewusersperdaypernewsgroup.model.DailyNewsgroupData");
		NUMBEROFNEWUSERS.setOwningType("org.ossmeter.metricprovider.historic.numberofnewusersperdaypernewsgroup.model.DailyNewsgroupData");
	}
