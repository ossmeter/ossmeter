package org.ossmeter.metricprovider.historic.numberofarticlesperday.model;
...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.historic.numberofarticlesperday.model.DailyNewsgroupData");
	}
