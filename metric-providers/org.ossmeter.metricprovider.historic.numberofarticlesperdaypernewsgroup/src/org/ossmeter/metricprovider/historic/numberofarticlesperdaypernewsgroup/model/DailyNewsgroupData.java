package org.ossmeter.metricprovider.historic.numberofarticlesperdaypernewsgroup.model;
...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		URL_NAME.setOwningType("org.ossmeter.metricprovider.historic.numberofarticlesperdaypernewsgroup.model.DailyNewsgroupData");
		NUMBEROFARTICLES.setOwningType("org.ossmeter.metricprovider.historic.numberofarticlesperdaypernewsgroup.model.DailyNewsgroupData");
	}
