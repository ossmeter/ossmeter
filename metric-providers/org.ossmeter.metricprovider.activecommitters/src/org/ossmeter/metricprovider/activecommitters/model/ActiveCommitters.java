...
public class ActiveCommitters extends PongoDB {
	
	public ActiveCommitters() {}
	
	public ActiveCommitters(DB db) {
		setDb(db);
	}
	...
	public void setDb(DB db) {
		super.setDb(db);
		newsgroups = new NewsgroupDataCollection(db.getCollection("ActiveCommitters.newsgroups"));
