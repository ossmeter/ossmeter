 ...
 *******************************************************************************/
package org.ossmeter.metricprovider.historic.newsgroups.sentiment.model;
...
public class NewsgroupsSentimentHistoricMetric extends Pongo {
	...
	public NewsgroupsSentimentHistoricMetric() { 
		super();
		OVERALLAVERAGESENTIMENT.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.sentiment.model.NewsgroupsSentimentHistoricMetric");
		OVERALLSENTIMENTATTHREADBEGGINING.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.sentiment.model.NewsgroupsSentimentHistoricMetric");
		OVERALLSENTIMENTATTHREADEND.setOwningType("org.ossmeter.metricprovider.historic.newsgroups.sentiment.model.NewsgroupsSentimentHistoricMetric");
	}
