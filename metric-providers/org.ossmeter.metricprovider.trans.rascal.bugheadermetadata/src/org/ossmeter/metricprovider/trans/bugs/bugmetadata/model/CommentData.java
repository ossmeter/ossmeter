...
public class CommentData extends Pongo {
	...
	public CommentData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.bugs.bugmetadata.model.CommentData");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.bugs.bugmetadata.model.CommentData");
		COMMENTID.setOwningType("org.ossmeter.metricprovider.trans.bugs.bugmetadata.model.CommentData");
