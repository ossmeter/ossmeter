...
public class BugTrackerCommentsData extends Pongo {
	...
	public BugTrackerCommentsData() { 
		super();
		BUGTRACKERID.setOwningType("org.ossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		BUGID.setOwningType("org.ossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		COMMENTID.setOwningType("org.ossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		SUBJECT.setOwningType("org.ossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		TEXT.setOwningType("org.ossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		DATE.setOwningType("org.ossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
	}
