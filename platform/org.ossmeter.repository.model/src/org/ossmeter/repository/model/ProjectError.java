...
public class ProjectError extends Pongo {
	...
	public ProjectError() { 
		super();
		DATE.setOwningType("org.ossmeter.repository.model.ProjectError");
		DATEFORERROR.setOwningType("org.ossmeter.repository.model.ProjectError");
		PROJECTID.setOwningType("org.ossmeter.repository.model.ProjectError");
		PROJECTNAME.setOwningType("org.ossmeter.repository.model.ProjectError");
		WORKERIDENTIFIER.setOwningType("org.ossmeter.repository.model.ProjectError");
		CLAZZ.setOwningType("org.ossmeter.repository.model.ProjectError");
		STACKTRACE.setOwningType("org.ossmeter.repository.model.ProjectError");
	}
