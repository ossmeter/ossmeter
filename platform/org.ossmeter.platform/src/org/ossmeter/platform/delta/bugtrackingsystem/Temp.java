...
public class Temp {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(d1.compareTo(d3));
		org.ossmeter.platform.Date dd1 = new org.ossmeter.platform.Date(d1);
		org.ossmeter.platform.Date dd2 = new org.ossmeter.platform.Date(d2);
		org.ossmeter.platform.Date dd3 = new org.ossmeter.platform.Date(d3);
